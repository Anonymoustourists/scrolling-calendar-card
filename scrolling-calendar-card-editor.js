            ...
            <div class="card-config">
                <div class="option-group">
                    ...
                    ${entities.map((entityConf, index) => {
                        ...
                        const color = typeof entityConf === 'string' ? '' : (entityConf.color || '#44739e');
                        
                        return html`
                            <div class="entity-row" style="display: flex; gap: 8px; margin-bottom: 8px; align-items: center;">
                                <input 
                                    type="text" 
                                    .value="${entityId}"
                                ...
                                >
                                <button @click="${() => this._removeEntity(index)}">X</button>
                            </div>
                        `;
                    })}
...
customElements.define("scrolling-calendar-card-editor", ScrollingCalendarCardEditor);
